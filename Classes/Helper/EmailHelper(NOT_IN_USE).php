<?php
namespace Slub\MatomoReporter\Helper;
...
class EmailHelper
{
    ...
    public static function resolveTemplateRootPaths($configurationManager = null)
    {
        if ($configurationManager) {
            ...
            $templateRootPaths = [Environment::getPublicPath() . '/typo3conf/ext/matomo_reporter/Resources/Private/Backend/Templates/'];
        }
    ...
    public static function resolvePartialRootPaths($configurationManager = null)
    {
        if ($configurationManager) {
            ...
            $partialRootPaths = [Environment::getPublicPath() . '/typo3conf/ext/matomo_reporter/Resources/Private/Backend/Partials/'];
        }
